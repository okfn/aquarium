...
module.exports = {
    ...
    getDocumentState: function(doc) {
      var available = doc.date_published || doc.available;
      var internal = !doc.available && doc.date_published;
      if (doc.expected_date_published &&
          moment(doc.expected_date_published) < moment()) {
        return 'not produced';
      }
